...
<div class="col-md-10">
    ...
    <div class="row">
        ...
        <div class="col-md-7">            
            <form id="classAttendanceForm" method="POST" class="form-horizontal" action="MarkStudentAttendanceServlet">
               <%
            ...
            %>
                        ...
                        <div class="form-group">
                            <div>
                                <button type="submit" class="btn btn-default" name="select" value="select">Save Attendance</button>
                            </div>
                        </div>
...
function updateClass(classId) {                       
                location.href = "MarkAttendance.jsp?classID=" + classId.value;
            }
            
function updateLesson(lessonId) {                      
                location.href = "MarkAttendance.jsp?lessonID=" + lessonId.value;
            }
</script>