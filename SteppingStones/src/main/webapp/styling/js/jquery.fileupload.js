...
function processCSVStudentData(csv_data,append_container,error_el,branch_id) {
    ...
    for(var i = 2; i < csv_data.length-1; i++) {
        ...
        Parent_nationaility = csv_data[i][9];
        ...
        html += "<div class='row' rel='"+i+"' id='row_con_" + i + "'>" +
                    ...
                    "<div class='col-sm-2'>"+ 
                      ...
                      "<input type='hidden' name='con_company[]' id='con_company_" + i + "' class='form-control' value = '" + Parent_company + "' readonly='readonly'>"+
                      "<input type='hidden' name='con_designation[]' id='con_designation_" + i + "' class='form-control' value = '" + Parent_designation + "'>"+
                      "<input type='text' name='con_mobile[]' id='con_mobile_num_" + i + "' class='form-control' value='" + Parent_mobile + "'>"+
