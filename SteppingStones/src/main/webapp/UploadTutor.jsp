...
%> 
<div class="col-md-10">
    <div style="text-align: center;margin: 20px;"><a href="CreateTutor.jsp">Add User </a> / <a class="active" href="UploadTutor.jsp">Upload User</a></h5></div>
    <div class="row">
        ...
        <div class="col-md-5 form" id='upload_container'>
            ...
            <div class="row">    
                <input type="file" name="upload_tutor_file" id="upload_tutor_file_id" class="form-control" onchange="checkCSVExtension('upload_tutor_file_id','tutor_upload_error','tutor_container','tutor')" />
