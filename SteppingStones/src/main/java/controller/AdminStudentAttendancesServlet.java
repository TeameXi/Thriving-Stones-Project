 ...
 * @author Xin
 */
@WebServlet(name = "AdminStudentAttendancesServlet", urlPatterns = {"/AdminStudentAttendancesServlet"})
public class AdminStudentAttendancesServlet extends HttpServlet {
