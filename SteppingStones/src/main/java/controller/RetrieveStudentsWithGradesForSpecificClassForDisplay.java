 ...
 * @author MOH MOH SAN
 */
@WebServlet(name = "RetrieveStudentsWithGradesForSpecificClassForDisplay", urlPatterns = {"/RetrieveStudentsWithGradesForSpecificClassForDisplay"})
public class RetrieveStudentsWithGradesForSpecificClassForDisplay extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(class_id != null && !class_id.equals("")){
                ...
                ArrayList<Grade> gradeList = StudentGradeDAO.listGradesFromSpecificClassIncludingRatio(classID);
                
                JSONArray studentsObjListsForClass = new JSONArray();
                
//                String CA1_0_improvement_rate = "-";
//                String SA1_0_improvement_rate = "-";
//                String CA2_0_improvement_rate = "-";
//                String SA2_0_improvement_rate = "-";
//                
//                
//                String CA1_1_improvement_rate = "-";
//                String SA1_1_improvement_rate = "-";
//                String CA2_1_improvement_rate = "-";
//                String SA2_1_improvement_rate = "-";
//                
//                String CA1_Comparison_remark = "";
//                String SA1_Comparison_remark = "";
//                String CA2_Comparison_remark = "";
//                String SA2_Comparison_remark = "";
