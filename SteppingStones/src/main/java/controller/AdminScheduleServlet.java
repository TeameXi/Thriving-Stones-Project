                ...
                case "updateClass": {
                    ...
                    if (obj.length() == 0) {
                        ...
                        if (obj.length() == 0) {
                            ...
                            overlappingLessons = lessonDAO.retrieveOverlapLessons(tutorID, pattern.print(start_time), pattern.print(end_time.minusMinutes(1)), cls.getClassID(), start_date.getDayOfWeek());

                            if (overlappingLessons) {
