 ...
 * method that close connections, statements and result sets
 */
public class ConnectionManager {
     ...
     */
    public static void closeConnectionIncludingResultSet(Connection conn, Statement stmt, ResultSet rs) {
        try {
            if (rs != null) {
                rs.close();
            }
